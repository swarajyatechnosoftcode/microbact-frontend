   ...
   <div className="min-h-screen bg-white relative">
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-12 pb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {[
            { icon: Phone, title: 'Call Us', info: '9518735229 / 9665755442', subinfo: 'Mon-Fri 9am-6pm', gradient: 'from-[#0A2C1D] to-[#0d3d26]', bgColor: 'bg-[#0A2C1D]/5', delay: '0s' },
                  ...
                  {['name', 'email'].map((field) => (
                    <div key={field}>
                      ...
                      <div className="relative">
                        ...
                        />
                        {focusedField === field && (
                          <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-[#0A2C1D]/20 to-[#0d3d26]/20 -z-10 blur-xl" />
                        )}
                      </div>
                    </div>
                  ))}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    {focusedField === 'subject' && (
                      <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-[#0d3d26]/20 to-[#0A2C1D]/20 -z-10 blur-xl" />
                    )}
                  </div>
                </div>
